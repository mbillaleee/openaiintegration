                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tb-col tb-col-end">
                                <a href="{{ route('edit.user.document', $document->id) }}" class="btn btn-success btn-sm">Edit</a>
                                <form action="{{ route('delete.user.document', $document->id) }}" method="POST" class="delete-form" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
