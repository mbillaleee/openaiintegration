        ...
        <div class="nk-block-head-between flex-wrap gap g-2">
            ...
            <div class="nk-block-head-content">
                <ul class="nk-block-tools">
                    <li><a class="btn btn-primary" href="{{ route('headings.create') }}"><em class="icon ni ni-plus"></em><span>Add Heading</span></a></li>
                </ul>
            </div>
        </div>
    </div><!-- .nk-page-head -->
...
<div class="card">
    <table class="table table-middle mb-0">
        ...
        <tr>
            ...
            <td class="tb-col tb-col-sm">
        <a href="{{ route('plans.edit',$item->id) }}" class="btn btn-success btn-sm">Edit</a>
         <a href="{{ route('plans.destroy',$item->id) }}" class="btn btn-danger btn-sm" id="delete">Delete</a> 
            </td>
